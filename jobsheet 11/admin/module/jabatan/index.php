<div class="container-fluid">
  ...
  <?php if (isset($_SESSION['flashdata'])) { ?>
    <?php foreach ($_SESSION['flashdata'] as $key => $val) { ?>
      <?= get_flashdata($key) ?>
    <?php } ?>
  <?php } ?>
      ...
      <tbody>
        ...
        ?>
          <tr>
            ...
            <td>
              <a href="index.php?page=jabatan/edit&id=<?= $row['id']; ?>" class="btn btn-warning btn-xs"><i class="fa fa-pencil-square-o" aria-hidden="true"></i> Edit</a>
              <a href="fungsi/hapus.php?jabatan=hapus&id=<?= $row['id']; ?>" onclick="return confirm('Hapus Data Jabatan?');" class="btn btn-danger btn-xs"><i class="fa fa-trash-o" aria-hidden="true"></i> Hapus</a>
            </td>
          </tr>
        <?php
        }
